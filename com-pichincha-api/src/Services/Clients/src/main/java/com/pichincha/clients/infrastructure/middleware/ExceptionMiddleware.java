package com.pichincha.clients.infrastructure.middleware;

import com.pichincha.clients.domain.exceptions.ClientsDomainException;
import com.pichincha.clients.domain.utils.ErrorUtils;
...
public class ExceptionMiddleware extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(ClientsDomainException.class)
    public final ResponseEntity<Object> handleAccountsDomainException(ClientsDomainException ex, WebRequest request) {
