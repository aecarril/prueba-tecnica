...
public class DepositCommandHandler implements CommandHandler<DepositCommand> {
    ...
    @Override
    public void handle(@NotNull DepositCommand command) {
        ...
        var movement = new Movement();
            ...
            movement.setMovementValue(command.getMoney());
            movement.setBalance(this.calculateBalance(account.getNumber(),
    ...
    private Double calculateBalance(String accountNumber, Double initialBalance, Double money) {
